...
This is a step-by-step guide on how to deploy the ipgeolocation-database-reader-0.8.war Java API and consume API responses.
...
- ipgeolocation-database-reader-0.8.war provided with this archive.
...
- Run the WAR file
    * `java -jar -Xms6G -Xmx10G /path/to/ipgeolocation-database-reader-0.8.war`  
    Note: -Xms6G flag sets the minimum RAM while -Xmx10G sets the maximum RAM allocated to execute the 'ipgeolocation-database-reader-0.8.war' application.  
