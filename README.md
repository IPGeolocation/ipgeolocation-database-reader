...
This is a step-by-step guide on how to deploy the ipgeolocation-database-reader-1.0.2.war Java API and consume API responses.
...
- ipgeolocation-database-reader-1.0.2.war provided with this archive.
...
- Run the WAR file
    * `java -jar -Xms6G -Xmx10G /path/to/ipgeolocation-database-reader-1.0.2.war`  
    Note: Use -Xms<ram_size1> flag to set the minimum RAM and -Xmx<ram_size2> to set the maximum RAM to be allocated to execute the 'ipgeolocation-database-reader-1.0.2.war' application.
